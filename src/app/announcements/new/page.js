    ...
    return (
        <div className="min-h-screen p-6 bg-gray-100 flex items-center justify-center">
            <div className="container max-w-screen-lg mx-auto">
                <div>
                    <h2 className="font-semibold text-xl text-gray-600">Nuevo anuncio</h2>
                    <p className="text-gray-500 mb-6">Introduzca los campos requeridos para crear un nuevo anuncio.</p>
